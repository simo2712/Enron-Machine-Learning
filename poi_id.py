...
#Create new labels and features without two new features
data = featureFormat(my_dataset, kbest_features_list + ['ratio_pay_over_stock'], sort_keys = True)
...
#try_classifier(features,labels)
#try_classifier(new_features,new_labels)
